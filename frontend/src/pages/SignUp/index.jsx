...
function SignUp () {
    ...
    function formSubmit(event) {
        ...
        if (!email || !password || !username) {
            ...
            (!textRegex.test(username)) ? alert("Le nom d'utilisateur ne doit contenir que des lettres ou des chiffres") : usernameValidity = true;
        ...
        <SignUpContainer>
            ...
            <SignUpBox>
                ...
                <SignUpForm onSubmit={(event) => formSubmit(event)}>
                    <label htmlFor="user" className="primary-color">Nom d'utilisateur</label>
